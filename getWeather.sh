...
ICON=`cat ~/code/weather/icon_key.txt | awk "{ if (\\$1==\"$CURRENT\") print }" | awk '{ print $2 }'`

cp /Users/cc2qe/code/weather/yahoo_weather_icons/HD_Yahoo_Icons/$ICON /Users/cc2qe/code/weather/current.png
